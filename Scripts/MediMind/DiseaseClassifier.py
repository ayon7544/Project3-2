...
class DiseaseClassifier:
    def __init__(self):
        ...
        self.disease_mapping = {
            ...
            29: 'Heartattack', 30: 'Varicoseveins', 31: 'Hypothyroidism', 32: 'Hyperthyroidism', 33: 'Hypoglycemia', 
            34: 'Osteoarthristis', 35: 'Arthritis', 36: '(vertigo) Paroymsal  Positional Vertigo', 37: 'Acne', 
    ...
    def get_disease(self, predicted):
        return self.disease_mapping.get(predicted[0], "Invalid index")
...
'Hepatitis B':20,'Hepatitis C':21,'Hepatitis D':22,'Hepatitis E':23,'Alcoholic hepatitis':24,'Hepatitis B':20,'Hepatitis C':21,'Hepatitis D':22,'Hepatitis E':23,'Alcoholic hepatitis':24,'Tuberculosis':25,
...
# Train the model
disease_classifier.train_model(X_train, np.ravel(y_train))

# Save the model
disease_classifier.save_model("disease_model.sav")

# Load the model
loaded_model = DiseaseClassifier.load_model("disease_model.sav")
